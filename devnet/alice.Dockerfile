...
ENTRYPOINT service datadog-agent start && gossamer --key=alice --babe-lead --publish-metrics --metrics-address=":9876" --rpc --rpc-external=true --pubdns=alice --port 7001 --ws --ws-external --rpc-unsafe --rpc-unsafe-external
